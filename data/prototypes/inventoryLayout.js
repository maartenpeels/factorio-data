module.exports = [
  {
    name: 'logistics',
    icon: 'graphics/item-group/logistics.png',
    subgroups: [
      {
        name: 'storage',
        items: [
  ...
  {
    name: 'production',
    icon: 'graphics/item-group/production.png',
    subgroups: [
      {
        name: 'tool',
        items: [
  ...
  },
  {
    ...
    icon: 'graphics/item-group/intermediate-products.png',
    subgroups: [
      {
        name: 'fluid_recipes',
        items: [
  ...
  {
    name: 'combat',
    icon: 'graphics/item-group/military.png',
    subgroups: [
      {
        name: 'gun',
        items: [
  ...
  {
    name: 'fluids',
    icon: 'graphics/item-group/fluids.png',
    subgroups: [
      {
        name: 'fluid',
        items: [
  ...
  {
    name: 'signals',
    icon: 'graphics/item-group/signals.png',
    subgroups: [
      {
        name: 'virtual_signal_special',
        items: [
          {
