{
  ...
  input_action = {
    ...
    activate_cut = 48,
    activate_paste = 49,
    add_permission_group = 202,
    add_train_station = 87,
    admin_action = 174,
    alt_select_area = 142,
    alt_select_blueprint_entities = 107,
    alternative_copy = 105,
    begin_mining = 2,
    begin_mining_terrain = 56,
    build_item = 54,
    build_rail = 139,
    build_terrain = 134,
    cancel_craft = 75,
    cancel_deconstruct = 127,
    cancel_new_blueprint = 19,
    cancel_research = 140,
    cancel_upgrade = 128,
    change_active_item_group_for_crafting = 89,
    change_active_item_group_for_filters = 99,
    change_active_quick_bar = 206,
    change_arithmetic_combinator_parameters = 129,
    change_blueprint_book_record_label = 122,
    change_decider_combinator_parameters = 130,
    change_item_label = 138,
    change_multiplayer_config = 173,
    change_picking_state = 175,
    change_programmable_speaker_alert_parameters = 132,
    change_programmable_speaker_circuit_parameters = 133,
    change_programmable_speaker_parameters = 131,
    change_riding_state = 57,
    change_shooting_state = 69,
    change_single_blueprint_record_label = 113,
    change_train_stop_station = 88,
    change_train_wait_condition = 135,
    change_train_wait_condition_data = 136,
    clean_cursor_stack = 11,
    clear_selected_blueprint = 144,
    clear_selected_deconstruction_item = 145,
    clear_selected_upgrade_item = 146,
    clone_item = 62,
    connect_rolling_stock = 8,
    copy = 104,
    copy_entity_settings = 21,
    craft = 67,
    create_blueprint_like = 117,
    cursor_split = 63,
    cursor_transfer = 61,
    custom_input = 137,
    ...
    delete_blueprint_record = 116,
    delete_custom_tag = 200,
    delete_permission_group = 201,
    destroy_opened_item = 23,
    disconnect_rolling_stock = 9,
    drag_train_schedule = 160,
    drag_train_wait_condition = 161,
    drop_blueprint_record = 115,
    drop_item = 53,
    drop_to_blueprint_book = 199,
    edit_custom_tag = 152,
    edit_permission_group = 153,
    export_blueprint = 124,
    fast_entity_split = 189,
    fast_entity_transfer = 187,
    go_to_train_station = 215,
    grab_blueprint_record = 114,
    gui_checked_state_changed = 91,
    gui_click = 84,
    gui_elem_changed = 158,
    gui_selection_state_changed = 92,
    gui_text_changed = 90,
    gui_value_changed = 93,
    import_blueprint = 125,
    import_blueprint_string = 154,
    import_permissions_string = 155,
    inventory_split = 74,
    inventory_transfer = 65,
    launch_rocket = 14,
    map_editor_action = 171,
    market_offer = 86,
    mod_settings_changed = 150,
    open_achievements_gui = 31,
    open_blueprint_library_gui = 15,
    open_blueprint_record = 111,
    open_bonus_gui = 29,
    ...
    open_train_gui = 195,
    open_train_station_gui = 213,
    open_trains_gui = 30,
    open_tutorials_gui = 32,
    paste_entity_settings = 22,
    place_equipment = 94,
    quick_bar_pick_slot = 168,
    quick_bar_set_selected_page = 169,
    quick_bar_set_slot = 167,
    remove_cables = 123,
    remove_train_station = 214,
    reset_assembling_machine = 12,
    rotate_entity = 188,
    select_area = 141,
    select_blueprint_entities = 106,
    select_entity_slot = 163,
    select_item = 162,
    select_mapper_slot = 165,
    select_next_valid_gun = 43,
    select_tile_slot = 164,
    set_auto_launch_rocket = 181,
    set_autosort_inventory = 180,
    set_behavior_mode = 186,
    set_car_weapons_control = 204,
    ...
    set_entity_color = 196,
    set_entity_energy_property = 151,
    set_filter = 76,
    set_heat_interface_mode = 212,
    set_heat_interface_temperature = 211,
    set_infinity_container_filter_item = 148,
    set_infinity_container_remove_unfiltered_items = 203,
    set_infinity_pipe_filter = 149,
    set_inserter_max_stack_size = 194,
    set_inventory_bar = 98,
    set_logistic_filter_item = 81,
    set_logistic_filter_signal = 82,
    set_logistic_trash_filter_item = 147,
    set_request_from_buffers = 205,
    set_research_finished_stops_game = 193,
    set_signal = 79,
    set_single_blueprint_record_icon = 110,
    set_splitter_priority = 209,
    set_train_stopped = 190,
    setup_assembling_machine = 70,
    setup_blueprint = 108,
    setup_single_blueprint_record = 109,
    smart_pipette = 72,
    stack_split = 73,
    stack_transfer = 64,
    start_repair = 101,
    start_research = 80,
    start_walking = 55,
    switch_connect_to_logistic_network = 185,
    switch_constant_combinator_state = 182,
    switch_inserter_filter_mode_state = 184,
    switch_power_switch_state = 183,
