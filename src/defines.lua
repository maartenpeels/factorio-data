{
  ...
  input_action = {
    add_permission_group = 176,
    alt_select_area = 127,
    alt_select_blueprint_entities = 92,
    begin_mining = 2,
    begin_mining_terrain = 44,
    build_item = 42,
    build_rail = 123,
    build_terrain = 118,
    cancel_craft = 62,
    cancel_deconstruct = 112,
    cancel_new_blueprint = 20,
    cancel_research = 124,
    change_active_item_group_for_crafting = 76,
    change_active_item_group_for_filters = 87,
    change_active_quick_bar = 15,
    change_arithmetic_combinator_parameters = 113,
    change_blueprint_book_record_label = 107,
    change_decider_combinator_parameters = 114,
    change_item_label = 122,
    change_picking_state = 148,
    change_programmable_speaker_alert_parameters = 116,
    change_programmable_speaker_circuit_parameters = 117,
    change_programmable_speaker_parameters = 115,
    change_riding_state = 45,
    change_shooting_state = 56,
    change_single_blueprint_record_label = 98,
    change_train_stop_station = 75,
    change_train_wait_condition = 119,
    change_train_wait_condition_data = 120,
    clean_cursor_stack = 11,
    clear_selected_blueprint = 129,
    clear_selected_deconstruction_item = 130,
    connect_rolling_stock = 8,
    copy_entity_settings = 22,
    craft = 54,
    create_blueprint_like = 102,
    cursor_split = 50,
    cursor_transfer = 49,
    custom_input = 121,
    ...
    deconstruct = 90,
    delete_blueprint_record = 101,
    delete_custom_tag = 174,
    delete_permission_group = 175,
    destroy_opened_item = 24,
    disconnect_rolling_stock = 9,
    drag_train_schedule = 140,
    drag_train_wait_condition = 141,
    drop_blueprint_record = 100,
    drop_item = 41,
    drop_to_blueprint_book = 173,
    edit_custom_tag = 135,
    edit_permission_group = 136,
    edit_train_schedule = 74,
    export_blueprint = 109,
    fast_entity_split = 163,
    fast_entity_transfer = 161,
    grab_blueprint_record = 99,
    gui_checked_state_changed = 78,
    gui_click = 71,
    gui_elem_changed = 138,
    gui_selection_state_changed = 79,
    gui_text_changed = 77,
    gui_value_changed = 80,
    import_blueprint = 110,
    import_blueprint_string = 137,
    inventory_split = 61,
    inventory_transfer = 52,
    launch_rocket = 14,
    market_offer = 73,
    ...
    open_item = 46,
    open_kills_gui = 18,
    open_logistic_gui = 39,
    open_mod_item = 47,
    open_production_gui = 17,
    open_technology_gui = 13,
    open_train_gui = 169,
    open_train_station_gui = 125,
    open_trains_gui = 30,
    ...
    rotate_entity = 162,
    select_area = 126,
    select_blueprint_entities = 91,
    select_entity_slot = 143,
    select_gun = 154,
    select_item = 142,
    select_tile_slot = 144,
    set_auto_launch_rocket = 156,
    set_autosort_inventory = 155,
    set_behavior_mode = 160,
    set_car_weapons_control = 178,
    set_circuit_condition = 65,
    set_circuit_mode_of_operation = 70,
    set_deconstruction_item_tile_selection_mode = 172,
    set_deconstruction_item_trees_and_rocks_only = 171,
    set_entity_color = 170,
    set_entity_energy_property = 134,
    set_filter = 63,
    set_infinity_container_filter_item = 132,
    set_infinity_container_remove_unfiltered_items = 177,
    set_inserter_max_stack_size = 168,
    set_inventory_bar = 86,
    set_logistic_filter_item = 68,
    set_logistic_filter_signal = 69,
    set_logistic_trash_filter_item = 131,
    set_request_from_buffers = 179,
    set_research_finished_stops_game = 167,
    set_signal = 66,
    set_single_blueprint_record_icon = 95,
    set_splitter_priority = 147,
    set_train_stopped = 164,
    setup_assembling_machine = 57,
    setup_blueprint = 93,
    setup_single_blueprint_record = 94,
    shortcut_quick_bar_transfer = 153,
    smart_pipette = 59,
    stack_split = 60,
    stack_transfer = 51,
    start_repair = 89,
    start_research = 67,
    start_walking = 43,
    switch_connect_to_logistic_network = 159,
    switch_constant_combinator_state = 157,
    switch_power_switch_state = 158,
    switch_to_rename_stop_gui = 28,
    take_equipment = 82,
    toggle_deconstruction_item_entity_filter_mode = 37,
    toggle_deconstruction_item_tile_filter_mode = 38,
    toggle_driving = 4,
    toggle_enable_vehicle_logistics_while_moving = 36,
    toggle_show_entity_info = 25,
    use_ability = 83,
    use_artillery_remote = 85,
    use_item = 84,
    wire_dragging = 55,
    write_to_console = 72
  },
